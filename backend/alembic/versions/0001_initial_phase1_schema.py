...
def upgrade() -> None:
    # The initial migration is intentionally idempotent so local databases
    # created by the pre-Alembic prototype can be adopted safely. Fresh
    # databases are still created entirely by Alembic.
    op.create_table(
        "document_templates",
    ...
    op.create_index("ix_document_templates_id", "document_templates", ["id"], if_not_exists=True)
    op.create_index("ix_document_templates_template_key", "document_templates", ["template_key"], if_not_exists=True)
    ...
    op.create_index("ix_documents_id", "documents", ["id"], if_not_exists=True)
    op.create_index("ix_documents_status", "documents", ["status"], if_not_exists=True)
    op.create_index("ix_documents_content_hash", "documents", ["content_hash"], if_not_exists=True)
    op.create_index("ix_documents_document_type_key", "documents", ["document_type_key"], if_not_exists=True)
    op.create_index("ix_documents_extraction_mode", "documents", ["extraction_mode"], if_not_exists=True)
    ...
    op.create_index("ix_field_definitions_id", "field_definitions", ["id"], if_not_exists=True)
    op.create_index("ix_field_definitions_template_id", "field_definitions", ["template_id"], if_not_exists=True)
    op.create_index("ix_field_definitions_field_key", "field_definitions", ["field_key"], if_not_exists=True)
    ...
    op.create_index("ix_processing_jobs_id", "processing_jobs", ["id"], if_not_exists=True)
    op.create_index("ix_processing_jobs_document_id", "processing_jobs", ["document_id"], if_not_exists=True)
    op.create_index("ix_processing_jobs_status", "processing_jobs", ["status"], if_not_exists=True)
    op.create_index("ix_processing_jobs_next_retry_at", "processing_jobs", ["next_retry_at"], if_not_exists=True)
    ...
    op.create_index("ix_extractions_id", "extractions", ["id"], if_not_exists=True)
    op.create_index("ix_extractions_document_id", "extractions", ["document_id"], if_not_exists=True)
    op.create_index("ix_extractions_field_definition_id", "extractions", ["field_definition_id"], if_not_exists=True)
    op.create_index("ix_extractions_template_key", "extractions", ["template_key"], if_not_exists=True)
    op.create_index("ix_extractions_standard_field_key", "extractions", ["standard_field_key"], if_not_exists=True)
    ...
    op.create_index("ix_corrections_id", "corrections", ["id"], if_not_exists=True)
    op.create_index("ix_corrections_extraction_id", "corrections", ["extraction_id"], if_not_exists=True)
    ...
    op.create_index("ix_audit_logs_id", "audit_logs", ["id"], if_not_exists=True)
    op.create_index("ix_audit_logs_document_id", "audit_logs", ["document_id"], if_not_exists=True)
    ...
    op.create_index("ix_document_ai_reviews_id", "document_ai_reviews", ["id"], if_not_exists=True)
    op.create_index("ix_document_ai_reviews_document_id", "document_ai_reviews", ["document_id"], if_not_exists=True)
    ...
    op.create_index("ix_ai_request_cache_id", "ai_request_cache", ["id"], if_not_exists=True)
    op.create_index("ix_ai_request_cache_cache_key", "ai_request_cache", ["cache_key"], if_not_exists=True)
    op.create_index("ix_ai_request_cache_content_hash", "ai_request_cache", ["content_hash"], if_not_exists=True)
    ...
    op.create_index("ix_ai_rate_limit_windows_id", "ai_rate_limit_windows", ["id"], if_not_exists=True)
    op.create_index("ix_ai_rate_limit_windows_provider", "ai_rate_limit_windows", ["provider"], if_not_exists=True)
    op.create_index("ix_ai_rate_limit_windows_model", "ai_rate_limit_windows", ["model"], if_not_exists=True)
    op.create_index("ix_ai_rate_limit_windows_window_type", "ai_rate_limit_windows", ["window_type"], if_not_exists=True)
    op.create_index("ix_ai_rate_limit_windows_window_start", "ai_rate_limit_windows", ["window_start"], if_not_exists=True)
